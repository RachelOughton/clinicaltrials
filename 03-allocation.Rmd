...
output %>% 
  htmlTable(header = c("Mustine (A)", "Talc (B)"),
            rnames = c(paste0("1.",intToUtf8(8804),"50"), "2. >50",
                       "1. I or II", "2. III or IV",
                       paste0("1. ",intToUtf8(8804),"30 months"),
                       "2. >30 months",
                       "1. Pre", "2. Post"),
...
$$
\begin{aligned}
\left(n^A_{1+++} - n^B_{1+++}\right) + \left(n^A_{+2++} - n^B_{+2++}\right) + \left(n^A_{++1+} &- n^B_{++1+}\right) + \left(n^A_{+++1} - n^B_{+++1}\right) \\

...
Recap: 
  ...
  * We constructed a measure $D = \frac{\bar{x}_T - \bar{x}_C}{s\sqrt{\frac{1}{n} + \frac{1}{m}}}$ that we can use to test $H_0:\; \tau=0$, since [approximately] $D\sim N\left(0,1\right)$.

...
Analysis:
  ...
  * Interested in whether Captopril has reduced BP for each individual - makes sense to compare change in BP ($X-P$), rather than final BP measurement.
...
All participants have been randomised from the same population, so we have 

...
```{r ovarian, fig.cap = "Kaplan Meier curves for the ovarian cancer data, split by treatment. Red is for group T, black for group C (placebo)."}
...
The second dataset is based on a trial of acute myeloid leukemia (this is simulated data, from the `survival` package)

...
#### Generalising this to two cases
...
:::{.exercise}
*This will be in the next formative assignment.* Following the same logic, derive a confidence interval for the Odds ratio. Calculate a 95% CI for the odds ratio for the Streptomycin example, and comment on the values.
:::

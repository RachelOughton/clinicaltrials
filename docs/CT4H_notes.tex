...
The preferred method from \citet{newcombe1998interval}, for its ease of implementation and its accuracy, is one that relies on \emph{score statistics}.
...
\includegraphics{CT4H_notes_files/figure-latex/unnamed-chunk-38-1.pdf}
\end{example}

\hypertarget{generalising-this-to-two-cases}{%
\subsubsection{Generalising this to two cases}\label{generalising-this-to-two-cases}}

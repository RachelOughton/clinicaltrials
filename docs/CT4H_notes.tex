...
In case you're reading the PDF, the notes are best viewed in HTML (the link is \url{https://racheloughton.github.io/clinicaltrials/}). The PDF will be up-to-date, but the formatting is designed for HTML.
...
\includegraphics{CT4H_notes_files/figure-latex/unnamed-chunk-70-1.pdf}
\end{example}
